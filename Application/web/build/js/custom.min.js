...
for (let l of competenceList){
    l.click(function(){
       if (this.childNodes[2].checked===true){
           ...
           this.css('color', '#522472');
       } else {
        this.childNodes[2].checked=true;
        this.css('background-color', '#522472');
        this.css('color', '#fff');
       }
    });
}

var skillPoint = $(".ratingStar");
for (let s of skillPoint){
    s.click(function(){
        $('#ratingSkillModal').show();
    });
}*/
...
function init_sidebar() {
    var a = function () {
        ...
        var a = $BODY.outerHeight(),
            ...
            d = a < c ? c : a;
        d -= $NAV_MENU.height(), $RIGHT_COL.css("min-height", d)
    };
...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [ //valeur graphe Dashboard 1 (Bleu)
                [gd(2012, 1, 1), 17],
                [gd(2012, 1, 2), 74],
                [gd(2012, 1, 3), 6],
                [gd(2012, 1, 4), 39],
                ...
                [gd(2012, 1, 6), 85],
                [gd(2012, 1, 7), 7]
            ], b = [ //values graphe Dashboard 1 (Rouge)
                [gd(2012, 1, 1), 82],
                [gd(2012, 1, 2), 23],
                [gd(2012, 1, 3), 66],
                [gd(2012, 1, 4), 9],
                ...
                [15, 4],
                [16, 45]
            ], f = 0; f < 30; f++) d.push([new Date(Date.today().add(f).days()).getTime(), randNum() + f + f + 10]); //values graphe Dashboard 2 (random)
        var g = {
                series: { //graphe Dashboard 1
                    lines: {
                        show: !1,
                        fill: !0
                    },
                ...
                colors: ["rgba(92, 49, 122, 1)", "rgba(141, 73, 188, 1)"], //colors lines graphe
                xaxis: {
                    tickColor: "rgba(51, 51, 51, 0.06)", //colors vertical lines grille
                    mode: "time",
                    tickSize: [1, "day"], //scale bottom
                    axisLabel: "Date",
                ...
                yaxis: {
                    ticks: 8, //number of graduation
                    tickColor: "rgba(51, 51, 51, 0.06)" //colors horizontal lines grille
                },
                tooltip: !1
            },
            h = { // graphe Dashboard 2
                grid: {
                    show: !0,
                    aboveData: !0,
                    color: "#3f3f3f",
                ...
                legend: {
                    position: "ne", // north (n) - south (s) - est (e) - ouest (o)
                    margin: [0, -25],
                    noColumns: 0,
                ...
                colors: ["#96CA59", "#3F97EB", "#72c380", "#6f7a8a", "#f7cb38", "#5a8022", "#2c7282"], //colors circles
                shadowSize: 0,
                tooltip: !0,
                tooltipOpts: {
                    content: "%s: %y.0",
                ...
                xaxis: {
                    ...
                    timeformat: "%d/%m/%y",
                    min: d[0][0],
                    max: d[20][0] //steps courbe graphe
                }
            },
            i = { //graphe Dashboard 3
                series: {
                    curvedLines: {
                        apply: !0,
                        active: !0,
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        ...
        labels: ["Connexion"],
        barRatio: .4,
        barColors: ["#522472", "#34495E", "#ACADAC", "#3498DB"],
        xLabelAngle: 0,
        hideHover: "auto",
        resize: !0
        ...
        if ($("#mainb").length) {
            ...
            b.setOption({
                ...
                series: [{
                    name: "Objectifs",
                    type: "bar",
                    data: [22, 49, 70, 23, 25, 74, 135, 162],
                    markPoint: {
                        data: [{
                            type: "max",
                            name: "???"
                    ...
                    name: "Merges",
                    type: "bar",
                    data: [22, 49, 72, 26, 28, 70, 133, 164],
                    markPoint: {
                        data: [{
                            name: "sales",
                            value: 182.2,
